...
(() => {
      ...
      465: function (t) {
        (t.exports = (function () {
              ...
              (function (t, e) {
                ...
                (function (t, e) {
                  var n = Ot.innerParams.get(t),
                    r = I();
                  if (r) {
                    if (n && e.icon === n.icon) return Gt(r, e), void qt(r, e);
                    if (e.icon || e.iconHtml) {
            ...
            Oe = function (t, e) {
              ...
              if (n) {
                ...
                O(e.inputOptions) || j(e.inputOptions)
                  ? (Ce(G()),
                    B(e.inputOptions).then(function (e) {
                      t.hideLoading(), r(e);
                    }))
          ...
          var je = function t(e) {
            ...
            De = function (t, e, n) {
              ...
              t.disableInput(),
                Promise.resolve()
                  .then(function () {
                    return B(r.inputValidator(e, r.validationMessage));
                  })
                  .then(function (r) {
                    t.enableButtons(),
                      t.enableInput(),
              ...
              n.showLoaderOnDeny && Ce(H()),
                n.preDeny
                  ? ((t.isAwaitingPromise = !0),
                    Promise.resolve()
                      .then(function () {
                        return B(n.preDeny(e, n.validationMessage));
                      })
                      .then(function (n) {
                        !1 === n
                          ? (t.hideLoading(), ge(t))
              ...
              n.showLoaderOnConfirm && Ce(),
                n.preConfirm
                  ? (t.resetValidationMessage(),
                    ...
                    Promise.resolve()
                      .then(function () {
                        return B(n.preConfirm(e, n.validationMessage));
                      })
                      .then(function (n) {
                        pt(z()) || !1 === n
                          ? (t.hideLoading(), ge(t))
          ...
          var Ln,
            ...
            Bn = ["swal-title", "swal-html", "swal-footer"],
            jn = function (t) {
              var e = {};
              return (
          ...
          (Xn.prototype.disableButtons = Ye),
            ...
            (Xn.prototype.hideLoading = qe),
            (Xn.prototype.disableLoading = qe),
  ...
  (n.d = (t, e) => {
    ...
    (() => {
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 4:
                              ...
                              (c = r.toDataURL("image/png")),
                                ((l = document.createElement("a")).href = c),
                                (l.download = "withoutGrid.png"),
                                l.click(),
                                (u = this.canvasElement.toDataURL("image/png")),
                                ((h = document.createElement("a")).href = u),
        ...
        return (
          (t = function t() {
            !(function (t, e) {
              ...
              gt(this, "prevBtnElement", void 0),
              gt(this, "feedBackBtnElement", void 0),
              gt(this, "paintingToolContainer", void 0),
              gt(this, "moveContainer", void 0),
        ...
        return (
          (t = function t() {
            !(function (t, e) {
              ...
              Ct(this, "containerElement", void 0),
              Ct(this, "pencilBtnElement", void 0),
              Ct(this, "eraserBtnElement", void 0),
              Ct(this, "clearBtnElement", void 0),
              Ct(this, "feedBackBtnElement", void 0),
              Ct(this, "timerElement", void 0),
              Ct(this, "paintingToolContainer", void 0),
              Ct(this, "parent", void 0),
              Ct(this, "root", void 0),
              (this.containerElement = document.createElement("div"));
          }),
          (e = [
        ...
        return (
          (t = function t() {
            !(function (t, e) {
              ...
              jt(this, "canvasFlag", void 0),
              jt(this, "isDrawing", void 0),
              jt(this, "containerElement", void 0),
              jt(this, "canvasElement", void 0),
              jt(this, "toolBarElement", void 0),
              jt(this, "root", void 0),
              (this.containerElement = document.createElement("div"));
          }),
          (e = [
            ...
            },
            {
              ...
              value: function () {
                var t,
                  e = Pt(this.canvasElement.canvasElements);
                try {
        ...
        return (
          (t = function t() {
            !(function (t, e) {
              ...
              It(this, "fontSelectWrapper", void 0),
              It(this, "fontContainer", void 0),
              It(this, "previewCanvas", void 0),
              (this.containerElement = document.createElement("div"));
          }),
          (e = [
            {
        ...
        return (
          (t = function t() {
            !(function (t, e) {
              ...
              zt(this, "status", void 0),
              zt(this, "containerElement", void 0),
              zt(this, "canvasContainerElement", void 0),
              zt(this, "mypageContainerElement", void 0),
              zt(this, "root", void 0),
              (this.containerElement = document.createElement("div")),
              (this.canvasContainerElement = new _t());
          }),
          (e = [
            {
              key: "setDomNode",
            ...
            },
            {
              ...
              value: function () {
                2 == this.status ? this.removeMyPage() : this.removeCanvas(),
                  (this.status = 2),
                  (this.mypageContainerElement = new Ft()),
        ...
        return (
          (t = function t() {
            !(function (t, e) {
              ...
              Yt(this, "myPageButtonElement", void 0),
              Yt(this, "basicPracticeButtonElement", void 0),
              Yt(this, "practiceButtonElement", void 0),
              Yt(this, "fontGenerateButtonElement", void 0),
              Yt(this, "root", void 0),
              Yt(this, "parent", void 0),
              (this.containerElement = document.createElement("div")),
        ...
        return (
          (t = function t() {
            !(function (t, e) {
              ...
              ne(this, "containerElement", void 0),
              ne(this, "titleElement", void 0),
              ne(this, "rankListContainer", void 0),
              ne(this, "rankTable", void 0),
              ne(this, "root", void 0),
              (this.containerElement = document.createElement("div")),
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              try {
                                (e = response.data.rows),
                                  this.updateRankList(e);
                              } catch (t) {
                                console.error(
        ...
        return (
          (t = function t() {
            !(function (t, e) {
              ...
              se(this, "logoElement", void 0),
              se(this, "exceptLogoElement", void 0),
              se(this, "menuElement", void 0),
              se(this, "leaderBoardElement", void 0),
              se(this, "leaderBoardComponent", void 0),
              se(this, "root", void 0),
              (this.containerElement = document.createElement("div"));
          }),
          (e = [
            {
              ...
              value: function (t) {
                (this.root = t),
                  ...
                  new Xt().render(t, this.exceptLogoElement),
                  (this.leaderBoardComponent = new oe()),
        ...
        return (
          (t = function t() {
            !(function (t, e) {
              ...
              fe(this, "containerElement", void 0),
              fe(this, "rightElement", void 0),
              fe(this, "leftElement", void 0),
              (this.containerElement = document.createElement("div"));
          }),
          (e = [
            {
              ...
              value: function () {
                ...
                (this.flag = !0),
                  ...
                  (this.rightElement = new Ut()),
                  (this.leftElement = new le()),
      ...
      const ye = { type: "error", data: "parser error" },
        we =
        ...
        Ee = ({ type: t, data: e }, n, r) =>
          we && e instanceof Blob
            ? n
              ? r(e)
              : xe(e, r)
            : ge && (e instanceof ArrayBuffer || be(e))
            ? n
              ? r(e)
              : xe(new Blob([e]), r)
            : r(me[t] + (e || "")),
      ...
      let Ce;
      const Se = "undefined" == typeof Uint8Array ? [] : new Uint8Array(256);
      for (let t = 0; t < 64; t++)
        Se[
      ...
      const Le = "function" == typeof ArrayBuffer,
        Te = (t, e) => {
          if ("string" != typeof t) return { type: "message", data: Oe(t, e) };
          const n = t.charAt(0);
          return "b" === n
            ? { type: "message", data: Pe(t.substring(1), e) }
            : ve[n]
            ? t.length > 1
              ? { type: ve[n], data: t.substring(1) }
              : { type: ve[n] }
            : ye;
        },
        Pe = (t, e) => {
          if (Le) {
            const n = ((t) => {
              ...
              for (e = 0; e < s; e += 4)
                (n = Se[t.charCodeAt(e)]),
                  (r = Se[t.charCodeAt(e + 1)]),
                  (o = Se[t.charCodeAt(e + 2)]),
                  (i = Se[t.charCodeAt(e + 3)]),
                  (u[c++] = (n << 2) | (r >> 4)),
                  (u[c++] = ((15 & r) << 4) | (o >> 2)),
                  (u[c++] = ((3 & o) << 6) | (63 & i));
              return l;
      ...
      const Re = De.setTimeout,
        Fe = De.clearTimeout;
      function Me(t, e) {
        e.useNativeTimers
          ? ((t.setTimeoutFn = Re.bind(De)), (t.clearTimeoutFn = Fe.bind(De)))
      ...
      class ze extends Ne {
        ...
        onError(t, e, n) {
          return super.emitReserved("error", new qe(t, e, n)), this;
        }
        open() {
        ...
        onData(t) {
          const e = Te(t, this.socket.binaryType);
          this.onPacket(e);
        }
        onPacket(t) {
      ...
      function Xe(t) {
        let e = "";
        do {
          (e = Ge[t % Ue] + e), (t = Math.floor(t / Ue));
        } while (t > 0);
        return e;
      }
      function $e() {
        const t = Xe(+new Date());
        return t !== Ve ? ((Ye = 0), (Ve = t)) : t + "." + Xe(Ye++);
      }
      for (; We < Ue; We++) He[Ge[We]] = We;
      let Ke = !1;
      try {
        Ke =
      ...
      function Ze(t) {
        const e = t.xdomain;
        try {
          if ("undefined" != typeof XMLHttpRequest && (!e || Je))
      ...
      function Qe() {}
      const tn = null != new Ze({ xdomain: !1 }).responseType;
      class en extends Ne {
        constructor(t, e) {
          super(),
            Me(this, e),
        ...
        create() {
          ...
          "undefined" != typeof document &&
            ((this.index = en.requestsCount++),
            (en.requests[this.index] = this));
        }
        onError(t) {
        ...
        cleanup(t) {
          if (void 0 !== this.xhr && null !== this.xhr) {
            if (((this.xhr.onreadystatechange = Qe), t))
              try {
                this.xhr.abort();
              } catch (t) {}
            "undefined" != typeof document && delete en.requests[this.index],
              (this.xhr = null);
          }
        }
        onLoad() {
      ...
      (en.requestsCount = 0),
        ...
        "undefined" != typeof document &&
          ("function" == typeof attachEvent
            ? attachEvent("onunload", nn)
            : "function" == typeof addEventListener &&
              addEventListener(
                "onpagehide" in De ? "pagehide" : "unload",
                nn,
                !1
              ));
      const rn =
          "function" == typeof Promise && "function" == typeof Promise.resolve
            ...
            : (t, e) => e(t, 0),
        on = De.WebSocket || De.MozWebSocket,
        an =
          "undefined" != typeof navigator &&
          "string" == typeof navigator.product &&
          "reactnative" === navigator.product.toLowerCase(),
        sn = {
          websocket: class extends ze {
            constructor(t) {
            ...
            doOpen() {
              ...
              try {
                this.ws = an ? new on(t, e, n) : e ? new on(t, e) : new on(t);
              } catch (t) {
                  ...
                  this.transport.createBidirectionalStream().then((t) => {
                    const e = (function (t, e) {
                          ...
                          transform(a, s) {
                            for (n.push(a); ; ) {
                              if (0 === r) {
                                ...
                                if (Ae(n) < o) break;
                                const t = _e(n, o);
                                s.enqueue(Te(i ? t : je.decode(t), e)), (r = 0);
                              }
                              if (0 === o || o > t) {
                                s.enqueue(ye);
                                break;
                      ...
                      r = new TransformStream({
                        transform(t, e) {
                          !(function (t, e) {
                            we && t.data instanceof Blob
                              ? t.data.arrayBuffer().then(ke).then(e)
                              : ge &&
                                (t.data instanceof ArrayBuffer || be(t.data))
                              ? e(ke(t.data))
                              : Ee(t, !1, (t) => {
                                  Ce || (Ce = new TextEncoder()),
                                    e(Ce.encode(t));
                                });
                          })(t, (n) => {
                            const r = n.length;
        ...
        constructor(t, e = {}) {
          super(),
            ...
            t
              ...
              : e.host && (e.hostname = un(e.host).host),
            Me(this, e),
            (this.secure =
              null != e.secure
                ? e.secure
                ...
                if (!n)
                  if ("pong" === t.type && "probe" === t.data) {
                    if (
                      ...
                      return;
                    (hn.priorWebsocketSuccess = "websocket" === e.name),
      ...
      const fn = "function" == typeof ArrayBuffer,
        ...
        mn =
          "function" == typeof Blob ||
          ("undefined" != typeof Blob &&
            "[object BlobConstructor]" === pn.call(Blob)),
        vn =
          "function" == typeof File ||
          ("undefined" != typeof File &&
            "[object FileConstructor]" === pn.call(File));
      function yn(t) {
        return (
          (fn && (t instanceof ArrayBuffer || dn(t))) ||
          (mn && t instanceof Blob) ||
          (vn && t instanceof File)
        );
      }
      function wn(t, e) {
        if (!t || "object" != typeof t) return !1;
        if (Array.isArray(t)) {
          for (let e = 0, n = t.length; e < n; e++) if (wn(t[e])) return !0;
          return !1;
        }
        if (yn(t)) return !0;
        ...
        for (const e in t)
          if (Object.prototype.hasOwnProperty.call(t, e) && wn(t[e])) return !0;
        return !1;
      }
      function gn(t) {
        const e = [],
      ...
      function bn(t, e) {
        ...
        if (Array.isArray(t)) {
          ...
          for (let r = 0; r < t.length; r++) n[r] = bn(t[r], e);
          return n;
        }
        if ("object" == typeof t && !(t instanceof Date)) {
          const n = {};
          for (const r in t)
            Object.prototype.hasOwnProperty.call(t, r) && (n[r] = bn(t[r], e));
          return n;
        }
        return t;
      }
      ...
      function xn(t, e) {
        ...
        if (Array.isArray(t))
          for (let n = 0; n < t.length; n++) t[n] = xn(t[n], e);
      ...
      class Ln {
        ...
        encode(t) {
          return (t.type !== Sn.EVENT && t.type !== Sn.ACK) || !wn(t)
            ? [this.encodeAsString(t)]
            : this.encodeAsBinary({
                type: t.type === Sn.EVENT ? Sn.BINARY_EVENT : Sn.BINARY_ACK,
                nsp: t.nsp,
                data: t.data,
                id: t.id,
              });
        ...
        encodeAsString(t) {
          let e = "" + t.type;
          return (
            (t.type !== Sn.BINARY_EVENT && t.type !== Sn.BINARY_ACK) ||
              (e += t.attachments + "-"),
            t.nsp && "/" !== t.nsp && (e += t.nsp + ","),
            null != t.id && (e += t.id),
      ...
      class Pn extends Ne {
        ...
        add(t) {
          ...
          if ("string" == typeof t) {
            ...
            const n = e.type === Sn.BINARY_EVENT;
            n || e.type === Sn.BINARY_ACK
              ? ((e.type = n ? Sn.EVENT : Sn.ACK),
                (this.reconstructor = new On(e)),
                0 === e.attachments && super.emitReserved("decoded", e))
              : super.emitReserved("decoded", e);
          } else {
            if (!yn(t) && !t.base64) throw new Error("Unknown type: " + t);
            if (!this.reconstructor)
              throw new Error(
        ...
        static isPayloadValid(t, e) {
          switch (t) {
            ...
            case Sn.CONNECT_ERROR:
              return "string" == typeof e || Tn(e);
            case Sn.EVENT:
            case Sn.BINARY_EVENT:
              return (
                Array.isArray(e) &&
                ("number" == typeof e[0] ||
                  ("string" == typeof e[0] && -1 === kn.indexOf(e[0])))
              );
            case Sn.ACK:
            case Sn.BINARY_ACK:
      ...
      class On {
        ...
        takeBinaryData(t) {
          if (
            ...
            const t = En(this.reconPack, this.buffers);
      ...
      class An extends Ne {
        ...
        subEvents() {
          ...
          const t = this.io;
          this.subs = [
            Bn(t, "open", this.onopen.bind(this)),
            Bn(t, "packet", this.onpacket.bind(this)),
            Bn(t, "error", this.onerror.bind(this)),
            Bn(t, "close", this.onclose.bind(this)),
          ];
        }
        get active() {
          return !!this.subs;
        ...
        emit(t, ...e) {
          ...
          const n = { type: Sn.EVENT, data: e, options: {} };
          if (
        ...
        ack(t) {
          ...
          let n = !1;
          return function (...r) {
            n || ((n = !0), e.packet({ type: Sn.ACK, id: t, data: r }));
          };
        }
        onack(t) {
      ...
      (_n.prototype.duration = function () {
        ...
        (_n.prototype.setMin = function (t) {
          this.ms = t;
        }),
        (_n.prototype.setMax = function (t) {
          this.max = t;
        }),
        (_n.prototype.setJitter = function (t) {
          this.jitter = t;
        });
      class Nn extends Ne {
        constructor(e, n) {
        ...
        onopen() {
          ...
          const t = this.engine;
          this.subs.push(
            Bn(t, "ping", this.onping.bind(this)),
            Bn(t, "data", this.ondata.bind(this)),
            Bn(t, "error", this.onerror.bind(this)),
            Bn(t, "close", this.onclose.bind(this)),
            Bn(this.decoder, "decoded", this.ondecoded.bind(this))
          );
        }
        onping() {
          this.emitReserved("ping");
        ...
        socket(t, e) {
          ...
          return (
            n
              ...
              : ((n = new An(this, t, e)), (this.nsps[t] = n)),
            n
          );
        }
        _destroy(t) {
      ...
      function In(t, e) {
        ...
        const n = (function (t, e = "", n) {
          ...
          o = n.id,
          i = n.path,
          a = Dn[o] && i in Dn[o].nsps;
        let s;
        return (
          e.forceNew || e["force new connection"] || !1 === e.multiplex || a
            ? (s = new Nn(r, e))
            : (Dn[o] || (Dn[o] = new Nn(r, e)), (s = Dn[o])),
          n.query && !e.query && (e.query = n.queryKey),
          s.socket(n.path, e)
        );
      }
      Object.assign(In, { Manager: Nn, Socket: An, io: In, connect: In });
      var Rn = n(465);
      function Fn(t) {
        return (
          (Fn =
      ...
      var Gn = In("".concat("ws://barmi-server.onrender.com"));
      Gn.on("lobby", function () {
        ...
        return (
          (t = function t(e, n) {
            !(function (t, e) {
              ...
              qn(this, "entirePage", void 0),
              qn(this, "socket", void 0),
              (this.entirePage = e),
              (this.socket = n),
              ...
              value: function () {
                ...
                Gn.on("game:open", function (e, n) {
                  ...
                  Rn.fire({
                    ...
                    cancelButtonText: "거절",
                    didOpen: function () {
                      var t = Rn.getHtmlContainer().querySelector("b");
                      r = setInterval(function () {
                        t.textContent = Math.ceil(Rn.getTimerLeft() / 1e3);
                      }, 100);
                    },
                    willClose: function () {
                      clearInterval(r);
                    ...
                    e.isConfirmed
                      ? (n("yes"),
                        Rn.fire({
                          ...
                          didOpen: function () {
                            Rn.showLoading();
                            var t = Rn.getPopup().querySelector("b");
                            r = setInterval(function () {
                              t.textContent = Math.ceil(
                                Rn.getTimerLeft() / 1e3
                              );
                            }, 100);
                          },
                          ...
                          e.dismiss === Rn.DismissReason.timer &&
                            t.entirePage.convertToGame();
                        }),
                        Gn.once("game:start", function (e) {
                          Rn.close(), t.entirePage.convertToGame();
                        }))
                      : e.isDenied && n("no");
                  });
                }),
                  Gn.on("game:over", function (t) {
                    var e;
                    Rn.fire({
                      title: "점수 계산중!",
                      timerProgressBar: !0,
                      didOpen: function () {
                        ...
                        e = setInterval(function () {
                          t.textContent = "".concat(Rn.getTimerLeft());
                        }, 100);
                      },
                      willClose: function () {
                        clearInterval(e);
                      ...
                      t.dismiss === Rn.DismissReason.timer &&
      ...
      Promise.all(Hn).then(function () {
        var t = new pe();
        new Un(t, Gn), t.render();
      });
    })();
})();
